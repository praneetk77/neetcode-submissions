class Solution:
    ...
    # uses division
    # take total product and divide by each element
    # O(n) time O(1) space
    ...
    # Uses 2 extra arrays to store prefix and postfix result
    # O(n) time O(n) space
    ...
    # does not use division
    # Uses no extra space, all changes done in final result array
    # O(n) time O(1) space
